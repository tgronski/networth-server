...
describe("Wallets Endpoints", function () {
  ...
  const { testUsers, testWallets } = helpers.makeWalletsFixtures();
  ...
  before("clean the table", () => db.raw("TRUNCATE networth_wallet CASCADE"));

  afterEach("cleanup", () => db.raw("TRUNCATE networth_wallet CASCADE"));
